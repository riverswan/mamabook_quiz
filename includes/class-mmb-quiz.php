...
class Mmb_Quiz {
	 ...
	 *
	 * - Mmb_Quiz_Loader. Orchestrates the hooks of the plugin.
	 * - Mmb_Quiz_i18n. Defines internationalization functionality.
	 * - Mmb_Quiz_Admin. Defines all hooks for the admin area.
	 * - Mmb_Quiz_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-mmb-quiz-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-mmb-quiz-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-mmb-quiz-admin.php';
	 ...
	 *
	 * Uses the Mmb_Quiz_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_filter( 'sidebars_widgets', $post_types, 'delete_bigmir_widget', 10, 1 );
		$this->loader->add_action( 'init', $post_types, 'mmb_quiz_post_types', 2 );
		$this->loader->add_action( 'init', $post_types, 'mmb_quiz_taxonomy', 10 );
		$this->loader->add_action( 'wp', $post_types, 'mmb_compare_url', 10 );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Mmb_Quiz_Public( $this->get_plugin_name(), $this->get_version() );
